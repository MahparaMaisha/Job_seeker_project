            ...
            <tbody>
                <?php for ($i = 0; $i < count($data1); $i++) { ?>
                    <tr>
                        ...
                        <td>
                            <div class="btns">
                            <a href="#" class="description" onclick='openModal(<?php echo $data1[$i]["ApplyID"] ?>)'>View</a>

                            </div>
                            <div id="<?php echo $data1[$i]["ApplyID"] ?>" class="modal">
                                <div class="modal-content">
                                <span class="close-btn" id="close-modal" onclick='closeModal(<?php echo $data1[$i]["ApplyID"] ?>)'>&times;</span>
                                    <div class="section">
